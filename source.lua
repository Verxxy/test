...
local TTsmode = Instance.new("ScreenGui")
local TTsmodeFrame = Instance.new("Frame")
...
local TTsmode_2 = Instance.new("TextLabel")
...
--Properties:
TTsmode.Name = "TTsmode"
TTsmode.Parent = game.CoreGui
TTsmode.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

TTsmodeFrame.Name = "TTsmodeFrame"
TTsmodeFrame.Parent = TTsmode
TTsmodeFrame.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
TTsmodeFrame.BorderSizePixel = 0
TTsmodeFrame.Position = UDim2.new(0.212884605, 0, 0.190036908, 0)
TTsmodeFrame.Size = UDim2.new(0, 605, 0, 336)

MenuFrame.Name = "MenuFrame"
MenuFrame.Parent = TTsmodeFrame
...
TTsmode_2.Name = "TTsmode"
TTsmode_2.Parent = MenuFrame
TTsmode_2.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TTsmode_2.BackgroundTransparency = 1.000
TTsmode_2.Position = UDim2.new(0.045161292, 0, 0, 0)
TTsmode_2.Size = UDim2.new(0, 115, 0, 34)
TTsmode_2.Font = Enum.Font.GothamBlack
TTsmode_2.Text = "TTsmode"
TTsmode_2.TextColor3 = Color3.fromRGB(255, 255, 255)
TTsmode_2.TextSize = 20.000
...
DropShadowHolder.Parent = TTsmodeFrame
...
TTsmodeFrame.Active = true
TTsmodeFrame.Draggable = true
--[[
...
local function OZAKZ_fake_script() -- TTsmodeFrame.DragScript 
	local script = Instance.new('LocalScript', TTsmodeFrame)
...
coroutine.resume(coroutine.create(function()
    while wait(3) do
        local function main()
            ...
            loadstring(game:HttpGet('https://raw.githubusercontent.com/TTsmode/TTsmode/main/swagnames'))()
        end
...
UIS.InputBegan:Connect(function(key,b) 
    if key.KeyCode == Enum.KeyCode.V and not b then
        if TTsmodeFrame.Visible == true then
            TTsmodeFrame.Visible = false
        else
            TTsmodeFrame.Visible = true
        end
    end
...
local ModCheck = loadstring(game:HttpGet('https://raw.githubusercontent.com/TTsmode/TTsmode/main/modlist'))()
...
elseif table.find(swagmins, player.UserId) then
    ...
    IsMod = false
    DisableMod = false
    announce('Commands Loaded', 'join discord.gg/TTsmode for a list of commands', 10)
end
end)
